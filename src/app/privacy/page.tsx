...
export const metadata: Metadata = {
  ...
  description:
    "What TopX collects, why, who can see it, and the controls you have over your data.",
};
...
const sections: LegalSection[] = [
  {
    ...
    paragraphs: [
      "You create a TopX account with Google or Apple sign-in. We receive the account identifier and email address that service passes to us, and use it to create and secure your account.",
  ...
  {
    heading: "Information created by using TopX",
    bullets: [
  ...
  },
  {
    ...
    paragraphs: [
      "Content published to a public topic page is visible to anyone using TopX. Content on a private topic page is visible to people the owner has approved.",
  ...
  },
  {
    heading: "Advertising",
    paragraphs: [
      "TopX shows advertising in the app. Placements are associated with topic subject matter rather than with profiles built from your activity on other services.",
  ...
  },
  {
    heading: "Children",
    paragraphs: [
      "TopX is not intended for children under 13, and we do not knowingly collect personal information from them. If we learn that we have, we delete the account.",
    ],
  },
  {
...
export default function PrivacyPage() {
  return (
    <LegalDocument
      ...
      intro="TopX is built around subjects rather than personal profiles, and the data we collect reflects that. This policy sets out what we hold, why we hold it, and what you can do about it."
      sections={sections}
    />
  );
}
